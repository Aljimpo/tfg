			...
			<article>
				...
				<!-- creamos Formulario para la luz U.V -->
					<form action="..\Between.php" method="post" autocomplete="off"> 
						<fieldset id="group1"  style="border:0;">
									<input type="radio" name="group1" value="0" disabled><h1>Luz U.V permanente</h1>
								<br>
								
								<input type="radio" name="group1" value="2" checked ><h1>Luz U.V apagada</h1>
								<br>
				...
				<!-- creamos Formulario para el riego-->
						<fieldset id="group3" style="border:0;">
								...
								<h1> 
								<input type="radio"  style="opacity:0">Regar la planta <input type="number" id = "segsriego" name="segsriego" min="1" max="20" required readonly value=""/> 
								segundos</h1></br>
								</br>
