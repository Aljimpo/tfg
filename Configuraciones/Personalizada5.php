				...
				<!-- creamos Formulario para la luz U.V -->
					<form action="..\Between.php" method="post" autocomplete="off"> 
						<fieldset id="group1"  style="border:0;">
							...
							<input name="iniciotiempoluz" id = "charstype" type="time" value="13:09" required " readonly >
							<label for="finaltiemmpoluz"> <h1>a:</h1></label>
							<input id = "charstype1" type="time" name="finaltiempoluz" value="13:11"required  readonly >
							<label for="luzcadadias"><h1>cada</h1></label>
							<input id = "charstype2" type="number" min = "1" name="luzcadadias" required value="1" readonly><h1>dia /s</h1><input type=hidden name =iniciotiempoluz value ="13:09"><input type=hidden name =finaltiempoluz value ="13:11"><input type=hidden name =luzcadadias value ="1">
						</fieldset>
					...
					<!-- creamos Formulario para la ventilación -->
						...
						<fieldset id="group2" style="border:0;" >
								...
								<input id = "vent" type="time" name="iniciotiempovent" value="13:09"required readonly>
								<label for="finaltiemmpovent"><h1> a:</h1></label>
								<input id = "vent1" type="time" name="finaltiempovent" value="13:11"required readonly>
								<label for="ventcadadias"><h1>cada</h1></label>
								<input id = "vent2" type="number" min = "1" name="ventcadadias" value ="1" readonly >
								<h1>día /s</h1><input type=hidden name =iniciotiempovent value ="13:09"><input type=hidden name =finaltiempovent value ="13:11"><input type=hidden name =ventcadadias value ="1">
						</fieldset>
