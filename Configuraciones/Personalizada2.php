			...
			<article>
				...
				<!-- creamos Formulario para la luz U.V -->
					<form action="..\Between.php" method="post" autocomplete="off"> 
						<fieldset id="group1"  style="border:0;">
								<input type="radio" name="group1" value="0" required checked><h1>Luz U.V permanente</h1>
								<br>
								
								<input type="radio" name="group1" value="2" disabled><h1>Luz U.V apagada</h1>
								<br>
								
								<input type="radio" name="group1" value="1" disabled><h1>Luz U.V encendida de:</h1>
							<input name="iniciotiempoluz" id = "charstype" type="time" value="" required " readonly >
							<label for="finaltiemmpoluz"> <h1>a:</h1></label>
							<input id = "charstype1" type="time" name="finaltiempoluz" value=""required  readonly >
							<label for="luzcadadias"><h1>cada</h1></label>
							<input id = "charstype2" type="number" min = "1" name="luzcadadias" required value="" readonly><h1>dia /s</h1><input type=hidden name =iniciotiempoluz value =""><input type=hidden name =finaltiempoluz value =""><input type=hidden name =luzcadadias value ="">
						</fieldset>
					...
					<!-- creamos Formulario para la ventilación -->
						...
						<fieldset id="group2" style="border:0;" >
								...
								<input id = "vent" type="time" name="iniciotiempovent" value=""required readonly>
								<label for="finaltiemmpovent"><h1> a:</h1></label>
								<input id = "vent1" type="time" name="finaltiempovent" value=""required readonly>
								<label for="ventcadadias"><h1>cada</h1></label>
								<input id = "vent2" type="number" min = "1" name="ventcadadias" value ="" readonly >
								<h1>día /s</h1><input type=hidden name =iniciotiempovent value =""><input type=hidden name =finaltiempovent value =""><input type=hidden name =ventcadadias value ="">
						</fieldset>
				...
				<!-- creamos Formulario para el riego-->
						<fieldset id="group3" style="border:0;">
								...
								<input  type="radio" name="group3" value="1" disabled ><h1>Regar la planta cuando la humedad en el suelo sea menor a:</h1>
								<input id = "riego" type="number" min = "1" max = "100" name="iniciotiemporiego" required readonly value=""> %
								
								</br>
								<h1> 
								<input type="radio"  style="opacity:0">Regar la planta <input type="number" id = "segsriego" name="segsriego" min="1" max="20" required readonly value="10"/> 
								segundos</h1></br>
								</br>
								
								</br><input type=hidden name =iniciotiemporiego value =""><input type=hidden name =segsriego value ="10">
