<html>
		...
		<body>
			...
			<div id="mySidenav" class="sidenav">
				...
				<a href="../Automatización.php">Automatización</a>
			...
			<article>
				...
				<!-- creamos Formulario para la luz U.V -->
					<form action="..\Between.php" method="post" autocomplete="off"> 
						<fieldset id="group1"  style="border:0;">
								...
								<input type="radio" name="group1" value="1" checked ><h1>Luz U.V encendida de:</h1>
							<input name="iniciotiempoluz" id = "charstype" type="time" value="00:00" required " >
							<label for="finaltiemmpoluz"> <h1>a:</h1></label>
							<input id = "charstype1" type="time" name="finaltiempoluz" value="00:00"required   >
							<label for="luzcadadias"><h1>cada</h1></label>
							<input id = "charstype2" type="number" min = "1" name="luzcadadias" required value="1"><h1>dia /s</h1>
						</fieldset>
					...
					<!-- creamos Formulario para la ventilación -->
						...
						<fieldset id="group2" style="border:0;" >
								...
								<input id = "vent" type="time" name="iniciotiempovent" value="00:01"required>
								<label for="finaltiemmpovent"><h1> a:</h1></label>
								<input id = "vent1" type="time" name="finaltiempovent" value="12:01"required >
								<label for="ventcadadias"><h1>cada</h1></label>
								<input id = "vent2" type="number" min = "1" name="ventcadadias" value ="2"$required>
								<h1>día /s</h1>
						</fieldset>
				...
				<!-- creamos Formulario para el riego-->
						<fieldset id="group3" style="border:0;">
								...
								<input  type="radio" name="group3" value="1" checked ><h1>Regar la planta cuando la humedad en el suelo sea menor a:</h1>
								<input id = "riego" type="number" min = "1" max = "100" name="iniciotiemporiego" required value="3"> %
								
								</br>
								<h1> 
								<input type="radio"  style="opacity:0">Regar la planta <input type="number" id = "segsriego" name="segsriego" min="1" max="20" required  value="4"/> 
								segundos</h1></br>
								</br>
